...
class Task6():
    ...
    def __init__(self):
        ...
        self.d = {
            "Odintsovo": [
                {"begin_time": date + "21:30", "time_range": 30, "name": "Belorussky Railway Station"},
                {"begin_time": date + "14:40", "time_range": 3, "name": "Bakovka"},
                {"begin_time": date + "10:30", "time_range": 15, "name": "Gratifying"},
            ],

            "Bakovka": [
                {"begin_time": date + "07:45", "time_range": 3, "name": "Odintsovo"},
                {"begin_time": date + "14:20", "time_range": 10, "name": "Kursky Railway Station"},
                {"begin_time": date + "08:10", "time_range": 25, "name": "Savelovsky Railway Station"},
            ],
            "Gratifying": [
                {"begin_time": date + "08:10", "time_range": 15, "name": "Odintsovo"},
                {"begin_time": date + "09:40", "time_range": 60, "name": "Kursky Railway Station"},
                {"begin_time": date + "18:21", "time_range": 38, "name": "Savelovsky Railway Station"},
            ],
            "Belorussky Railway Station": [
                {"begin_time": date + "11:15", "time_range": 30, "name": "Odintsovo"},
                {"begin_time": date + "13:50", "time_range": 10, "name": "Kursky Railway Station"},
                {"begin_time": date + "20:52", "time_range": 5, "name": "Savelovsky Railway Station"},
            ],
            "Kursky Railway Station": [
                {"begin_time": date + "17:02", "time_range": 10, "name": "Belorussky Railway Station"},
                {"begin_time": date + "17:10", "time_range": 10, "name": "Bakovka"},
                {"begin_time": date + "15:58", "time_range": 60, "name": "Gratifying"},
            ],
            "Savelovsky Railway Station": [
                {"begin_time": date + "11:18", "time_range": 5, "name": "Belorussky Railway Station"},
                {"begin_time": date + "15:26", "time_range": 25, "name": "Bakovka"},
                {"begin_time": date + "19:10", "time_range": 38, "name": "Gratifying"},
            ],
        }
        self.way_inputer()
        self.way_recognizer()
