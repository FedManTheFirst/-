...
class MainProcessingClass(object):
    def __init__(self):
        ...
        self.student_list = [
            ["Ванифатов", "Артём", "Максимович", "2003", 3, "БИСО-01-20", [2, 5, 3, 4, 5]],
            ["Русаков", "Алексей", "Михайлович", "1984", 3, "БИСО-01-02", [2, 5, 3, 4, 5]],
            ["Арчевый", "Ежа", "Иголович", "2001", 1, "БИСО-01-20", [5, 5, 5, 4, 5]],
            ["Иванов", "Ваня", "Иванович", "2000", 1, "БИСО-01-20", [2, 3, 3, 4, 5]],
        ]
